...
title: "Access & Login"
category: "Views"
tags: ["login", "access", "roles", "web"]
---

# 📱 Accessing the App & Login

To use FloraSync on your phone or desktop, simply open your browser (Safari or Chrome) and navigate to:

**`https://florasync.theshaheens.info/`**

## The Login Screen & User Roles
Once you navigate to the URL, you will be greeted by the FloraSync Login Screen. Because FloraSync is designed for collaboration (like inviting a friend to garden-sit), you will need to authenticate to access your digital garden. 

Depending on your assigned role, your experience and permissions within the app will vary:
