...
export const Container = styled.div.attrs({
  className: 'min-h-screen bg-surface-50 dark:bg-surface-900 text-slate-800 dark:text-slate-100 font-sans p-4 pb-20 max-w-md mx-auto relative overflow-hidden transition-colors duration-300',
})``;
